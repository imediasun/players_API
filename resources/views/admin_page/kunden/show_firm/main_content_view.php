                                    ...
                                    <ul class="defould_list">
                                        <li class="mb-15">
                                            <p class="txt_contacts">
                                                <span class="col-md-4">Firmenname:</span> <p class="col-md-8"><?php echo $firm->company_name?></p></p>
                                            </p>
                                        </li>
                                        <li>
                                            <p class="txt_contacts">
                                                <span class="col-md-4">Adresse:</span> <p class="col-md-8"><?php echo $firm->street_house_number?></p>
                                            </p>
                                        </li>
                                        <li>
                                            <p class="txt_contacts">
                                                <span class="col-md-4">Webseite:</span> <p class="col-md-8"><?php $firm->website>"" ?  $www=$firm->website : $www="/"; echo $www?></p>
                                            </p>
                                        </li>
                                        <li>
                                            <p class="txt_contacts">
                                                <span class="col-md-4">E-Mail:</span> <p class="col-md-8"><?php echo $firm->email?></p>
                                            </p>
                                        </li>
                                        <li>
                                            <p class="txt_contacts">
                                                <span class="col-md-4">Telefon:</span> <p class="col-md-8"><?php $firm->telephone>"" ?  $tel=$firm->telephone : $tel="/"; echo $tel?></p>
                                            </p>
                                        </li>
                                        <li>
                                            <p class="txt_contacts">
                                                <span class="col-md-4">Telefon:</span> <p class="col-md-8"><?php $firm->telephone2>"" ?  $tel2=$firm->telephone2 : $tel2="/"; echo $tel2?></p>
                                            </p>
                                        </li>
                                        <li class="mb-15">
                                            <p class="txt_contacts">
                                                <span class="col-md-4">Fax:</span> <p class="col-md-8"><?php $firm->fax>"" ?  $fax=$firm->fax : $fax="/"; echo $fax?></p>
                                            </p>
                                        </li>
                                        <li>
                                            <p class="txt_contacts">
                                                <span class="col-md-4">Öffnungszeiten:</span> <p class="col-md-8"><?php echo $firm->created_at?></p>
                            ...
                            <div class="panel-group accordion custom_accordion" id="accordion1">
                                <div class="panel">
                                    ...
                                    <div class="panel-heading ovh">
                                        <h4 class="panel-title">
                                            <a data-parent="#accordion1" data-toggle="collapse" href="#collapseOne" class="ttu rotate_arrow_accordion" aria-expanded="true" >Max Mustermann
                                                <span class="cursor_pointer collapse_icon_font read_btn"><i class="workadvisor workadvisor-arrow-point-to-bottom"></i></span> </a>
                                        </h4>
                                        <div class="read_btn_box pull-right">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title ">
                                            <a data-parent="#accordion1" data-toggle="collapse" href="#collapseTwo" class="ttu rotate_arrow_accordion">Marcel Hadler <span class="cursor_pointer collapse_icon_font read_btn"><i class="workadvisor workadvisor-arrow-point-to-bottom"></i></span> </a>
                                        </h4>
                                        <div class="read_btn_box pull-right">
                                            <span class="cursor_pointer read_btn"><i class="workadvisor workadvisor-edit-tool"></i></span>
                                            <span class="cursor_pointer read_btn"><i class="workadvisor workadvisor-rubbish-bin"></i></span>
                                                    ...
                                                    <div class="notiz_panel_custom">
                                                        ...
                                                        <div class="col-md-4">
                                                            <ul class="list-inline text-right">
                                                                ...
                                                                <li>
                                                                        <span class="pull-right cursor_pointer pr-10">
                        ...
                        <div class="panel-body custom_top_line">
                            ...
                            <div class="panel-group accordion custom_accordion" id="accordion">
                                <div class="panel">
                                    ...
                                    <div class="panel-heading ovh">
                                        <h4 class="panel-title">
                                            <a data-parent="#accordion" data-toggle="collapse" href="#collapseThree" class="ttu rotate_arrow_accordion" aria-expanded="true" >Max Mustermann
                                                <span class="cursor_pointer collapse_icon_font read_btn"><i class="workadvisor workadvisor-arrow-point-to-bottom"></i></span> </a>
                                        </h4>
                                        <div class="read_btn_box pull-right">
                                            <span class="cursor_pointer read_btn"><i class="workadvisor workadvisor-on-off"></i></span>
                                            <span class="cursor_pointer read_btn"><i class="workadvisor workadvisor-edit-tool"></i></span>
                                            <span class="cursor_pointer read_btn"><i class="workadvisor workadvisor-rubbish-bin"></i></span>
                                        </div>
                                    </div>
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title ">
                                            <a data-parent="#accordion" data-toggle="collapse" href="#collapseFour" class="ttu rotate_arrow_accordion" >Marcel Hadler <span class="cursor_pointer collapse_icon_font read_btn"><i class="workadvisor workadvisor-arrow-point-to-bottom"></i></span> </a>
                                        </h4>
                                        <div class="read_btn_box pull-right">
                                            <span class="cursor_pointer read_btn"><i class="workadvisor workadvisor-on-off"></i></span>
                                            <span class="cursor_pointer read_btn"><i class="workadvisor workadvisor-edit-tool"></i></span>
