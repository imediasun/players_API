                            ...
                            <div class="row">
                                <div class="col-md-6 left-side">
                                    <div class="note-fontname btn-group">
                                        <h5>PLZ-Gebiet:</h5>
                                        <input type="text" placeholder="PLZ eingeben" id="index_sort" maxlength="5"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 right-checkbox">
                                            <button type="button"
                                                    ...
                                                    data-original-title="Font Family" aria-expanded="false"
                                                    id="all_services">
                                                <span class="note-current-fontname">Alle auswählen</span></button>
                                        ...
                                        <div class="col-md-8 right-checkbox">
                                            <div class="flex-start fais" style="flex-wrap: wrap">
                                                ...
                                                <label class="custom-checkbox"
                                                    ...
                                                    <input type="checkbox" value="heating_oil" class="service"
                                                           checked="checked">
                                                    <span></span>
                                                    Heizung Öil
                                                </label>
                                                <label class="custom-checkbox"
                                                       style="margin-right: 15px; margin-bottom: 10px;">
                                                    <input type="checkbox" value="heating_gas" class="service"
                                                           checked="checked">
                                                    <span></span>
                                                    Heizung Gas
                                                </label>
                                                <label class="custom-checkbox"
                                                       style="margin-right: 15px; margin-bottom: 10px;">
                                                    <input type="checkbox" value="solar" class="service"
                                                           checked="checked">
                                                    <span></span>
                                                    Solar
                                                </label>
                                                <label class="custom-checkbox"
                                                       style="margin-right: 15px; margin-bottom: 10px;">
                                                    <input type="checkbox" value="bath" class="service"
                                                           checked="checked">
                                                    <span></span>
                                                    Bad
                                                </label>
                                ...
                                <div class="col-xs-12 pl-0 pr-0 anfragen-card-nav">
                                    <div class="col-xs-6">
                                        ...
                                        <div style="display:inline-block;" class="checkbox">
                                            ...
                                            <label class="form-checkbox form-icon active form-text">
                                                <input id="published" type="checkbox"> Nicht veröffentlichte
                                                zuerst</label>
                                    ...
                                    <div class="col-xs-6">
                                        <div class="pull-right">
                                            ...
                                            <div id="order_date"
                                                 style="display:inline-block;margin-left:10px;color:#3da5ea;cursor:pointer">
                                                <h5>Datum</h5></div>
                                            <div id="post_index_sort"
                                                 style="display:inline-block;margin-left:10px;color:#b9c5cd;cursor:pointer">
                                                <h5>Postleitzahl</h5></div>
                                        </div>
...
//                                        https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=Sonnenstra%C3%9Fe+12,80331+M%C3%BCnchen&amp;destinations=Bunzlauer+Pl.+5,+M%C3%BCnchen&amp;key=AIzaSyARmeJZxBmgWPluo5vALvdT4_4JdgiNvDg
                                        ...
                                        <div class="col-xs-12 <?= $val['service'] ?> client_block"
                                             id="client<?php echo $val['id'] ?>">
                                            <div class="item_block ">
                                                <div class="block item_block_border">
                                                    ...
                                                    <div class="row mr-0">
                                                        <div class="col-xs-2 company-icon-wrap"
                                                        ...
                                                        <div class="col-xs-10 pl-0 pr-0 anfragen-card-body">
                                                                ...
                                                                <div class="flex-start">
                                                                    ...
                                                                    <ul class="list-inline text-right padding_li_2">
                                                                        <li class="tooltip_html list_icon">
                                                                            <span class="check_box_btn green_bg"> </span>
                                                                            ...
                                                                            <div class="tooltip_html_block popover top">
                                                                                ...
                                                                                <div class="popover-content">
                                                                                    <p class="fow600"><u> Wärme aus der
                                                                                            Natur-Niemann GmbH & Co.
                                                                                            KG</u></p>
                                                                                    <p class="green_color ">
                                                                                        <span class="check_box_btn green_bg"> <i
                                                                                                    class="workadvisor workadvisor-cheked"></i> </span>
                                                                                        Abgeschlossen
                                                                                    </p>
                                                                                    <p>

                                                                                        <a href="#"
                                                                                           class="blue_color litle_fonts mt-10 block"><i></i>Zum
                                                                                            Projekt Projekt #45465</a>
                                                                                    </p>
                                                                                    <p class="mb-0">

                                                                                        <a href="#"
                                                                                           class="blue_color litle_fonts mt-10 block"><i
                                                                                                    class="workadvisor workadvisor-enter blue_color pr-10"></i>Login
                                                                                            als Kunde</a>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                        ...
                                                                        <li class="tooltip_html list_icon">
                                                                            <span class="check_box_btn red_bg"> <i>€</i> </span>
                                                                            <div class="tooltip_html_block popover top">
                                                                                <div class="arrow"
                                                                                     style="left: 5%;"></div>
                                                                        ...
                                                                        <li>
                                                                            <span class="check_box_btn red_bg"> <i
                                                                                        class="workadvisor workadvisor-cheked"></i>  </span>
                                                                            <div class="tooltip_html_block popover top">
                                                                                <div class="arrow"
                                                                                     style="left: 5%;"></div>
                                                                ...
                                                                <div class="flex-end shrink">
                                                                    <div class="tooltip_html flex-start sichtbar">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <a href="#"
                                                                               class="blue_color fs12"><?php echo count($val['firm']) ?>
                                                                                Partners</a>
                                                                                ...
                                                                                <div class="popover-content">
                                                                                    <div class="nano nano-custom"
                                                                                        ...
                                                                                        <div class="nano-content">
                                                                                                <?php
                                                                                                foreach ($val['firm'] as $partner){
                                                                                                    echo '<p class="fow600"><span
                                                                                                        class="check_box_btn green_bg"> <i
                                                                                                            class="workadvisor workadvisor-cheked"></i> </span><a href="/admin/firm/'.
                                                                                                        $partner->id
                                                                                                        .'" target="_blank"><u>'.
                                                                    ...
                                                                    <div class="tooltip_html flex-start anfragen-card-ip">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <div class="tooltip_html_block popover top">
                                                                                ...
                                                                                <div class="popover-content">
                                                                                    <p class="txt_contacts"><span>IP Address:</span>
                                                                                        188.239.77.145</p>
                                                                                    <p class="txt_contacts"><span>Provider:</span>
                                                                                        Link Telecom Ltd</p>
                                                                                    <p class="txt_contacts">
                                                                                        <span>Stadt:</span> kremenchug
                                                                                    </p>
                                                                                    <a href="#"
                                                                                       class="blue_color litle_fonts mt-10 block"><i
                                                                                                class="workadvisor workadvisor-google-map blue_color pr-10"></i>Karte
                                                                                        ansehen google</a>
                                                                                </div>
                                                                    ...
                                                                    <div class=" p-0 flex-start anfragen-card-plz">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <h5 class="post_index"><?php echo $val['zip_code'] ?></h5>
                                                                        </div>
                                                                    </div>
                                                                    <div class="flex-start anfragen-card-time">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            ?>
                                                                            <h4 class="fs14 date_"><?php echo $date_ ?></h4>
                                                                            <h5><?php echo $time ?></h5>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="flex-between anfragen-card-content">
                                                                    ...
                                                                    foreach ($questinarys as $k => $v)
                                                                    {
                                                                        ...
                                                                        if ($v->id_question == 1 && ! isset($calendar))
                                                                        {
                                                                            ...
                                                                            <button class="btn btn-default btn-rounded">
                                                                                <i style="font-size:23px;color:#12aaeb"
                                                                                   class="workadvisor workadvisor-calendar">

                                                                                </i><span
                                                                                        style=""><?php echo $v->answer ?></span>
                                                                            </button>
                                                                        ...
                                                                        if ($v->id_question == 2 && ! isset($house_plan))
                                                                        {
                                                                            ...
                                                                            <button class="btn btn-default btn-rounded">
                                                                                <i style="font-size:23px;color:#12aaeb"
                                                                                   class="workadvisor workadvisor-house-plan">

                                                                                </i><span><?php echo $v->answer ?></span>
                                                                            </button>
                                                                        ...
                                                                        if ($v->id_question == 3 and ! isset($family))
                                                                        {
                                                                            ...
                                                                            <button class="btn btn-default btn-rounded">
                                                                                <i style="font-size:23px;color:#12aaeb"
                                                                                   class="workadvisor workadvisor-family">

                                                                                </i><span
                                                                                        style="padding-left:10px;"><?php echo $v->answer ?></span>
                                                                            </button>
                                                                        ...
                                                                        if ($v->id_question == 4 and ! isset($home))
                                                                        {
                                                                            ...
                                                                            <button class="btn btn-default btn-rounded">
                                                                                <i style="font-size:23px;color:#12aaeb"
                                                                                   class="workadvisor workadvisor-home">
                                                                        ...
                                                                        if ($v->id_question == 5 and ! isset($water))
                                                                        {
                                                                            ...
                                                                            <button class="btn btn-default btn-rounded">
                                                                                <i style="font-size:23px;color:#12aaeb"
                                                                                   class="workadvisor workadvisor-heating-oil">
                                                                        ...
                                                                        if ($v->id_question == 6 and ! isset($heating))
                                                                        {
                                                                            ...
                                                                            <button class="btn btn-default btn-rounded">
                                                                                <i style="font-size:23px;color:#12aaeb"
                                                                                   class="workadvisor workadvisor-heating">
                                                                ...
                                                                <div class="addresse">
                                                                    <div class="flex-start">
                                                                        <h5 style="color:#9da5b0" class="shrink">
                                                                            Name:</h5>
                                                                        <h5 id="first_name_xed_<?php echo $val['id'] ?>"
                                                                            style="color:#000"><?php echo $val['first_name'] ?></h5>
                                                                    ...
                                                                    <div class="flex-start">
                                                                        <h5 style="color:#9da5b0" class="shrink">
                                                                            Telefon:</h5>
                                                                        <h5 id="telephone_xed_<?php echo $val['id'] ?>"
                                                                            style="color:#000"><?php echo $val['telephone'] ?></h5>
                                                                    ...
                                                                    <div class="flex-start">
                                                                        ...
                                                                        <h5 style="color:#9da5b0" class="shrink">
                                                                            Adresse:</h5>
                                                                        <h5 id="adress_xed_<?php echo $val['id'] ?>"
                                                                            style="color:#000"><?php echo $val['street_house_number'] ?></h5>
                                                                        <script>
                                                                ...
                                                                <div class="telefonische">
                                                                    <h5 style="color:#9da5b0">Telefonische
                                                                        Erreichbarkeit:</h5>
                                                                    <h5 style="color:#000"><?php echo $val['reachability'] ?></h5>
                                                                </div>

                                                                <div class="offentlich offentlich1">
                                                                    ...
                                                                    <div class="box-inline">
                                                                        ...
                                                                        <input class="hidden_active" type="hidden"
                                                                        ...
                                                                        if ($val['active'] == 1)
                                                                        {
                                                                            ...
                                                                            ?>
                                                                            <input class="js-switch ofentlich publish"
                                                    ...
                                                    <div class="row mr-0">
                                                        <div class="panel-footer bgt bt-1 anfragen-card-foot">
                                                            ...
                                                            <ul class="pull-right butons_list">
                                                                <li>
                                                                    <button data-target="#demo-default-modal"
                                                                            data-toggle="modal"
                                                                            class="btn-md btn_links"><i
                                                                                class="workadvisor workadvisor-edit-tool"></i>
                                                                        <span>Bearbeiten</span></button>
                                                                </li>
                                                                <li>
                                                                    <input class="hidden_active" type="hidden"
                                                                           value="<?php echo $val['id'] ?>">
                                                                    <button class="del_client_btn btn-md btn_links"
                                                                            onclick="Anfragen.delete_client(this)"><i
                                                                                class="workadvisor workadvisor-rubbish-bin"></i><span>Entfernen</span>
                                                                    </button>
                                                                </li>
                                                            </ul>
                                                            ...
                                                            <div class="additional_info additional_info_custom">
                                                                ...
                                                                <div class="scroll_btn icon_links "></div>
                                                    ...
                                                    <div class="modal-content ">
                                                        <form action="admin/client_general_information" method="post">
                                                            ...
                                                            <div class="custom-modal-header custom-modal-header-xs admin-anfregen-page-modal-header">
                                                                ...
                                                                <button type="submit" class="btn blue_custom_btn">Save
                                                                    changes
                                                                </button>
                                                            ...
                                                            <div class="modal-body ovh">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xs-12 col-md-6 mb_row">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-xs-12 col-sm-8">
                                                                                <input name="id" type="hidden"
                                                                                       value="<?php echo $val['id'] ?>">
                                                                                <input id="demo-text-input"
                                                                                       name="first_name"
                                                                                       class="form-control"
                                                                                       placeholder="Name"
                                                                                       value="<?php echo $val['first_name'] ?>"
                                                                                       type="text">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-xs-12 col-sm-8">
                                                                                <input id="demo-text-input" name="zip"
                                                                                       style="width:33%;display:inline-block"
                                                                                       class="form-control"
                                                                                       placeholder="Zip code"
                                                                                       type="text"
                                                                                       value="<?php echo $zip ?>">
                                                                                <input id="demo-text-input" name="city"
                                                                        ...
                                                                        <div class="row additional_address"
                                                                             style="display:none">
                                                                            <div class="col-xs-12 col-sm-4">
                                                                    ...
                                                                    <div class="col-xs-12 col-md-6"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-xs-12 col-sm-4"
                                                                                ...
                                                                                <select name="phone_type"
                                                                                        data-placeholder="Choose a telefone..."
                                                                                        class="form-control">
                                                                                    <option value="Mobile">Mobile
                                                                                    </option>
                                                                                    <option value="Mobile2">Mobile2
                                                                                    </option>
                                                                        ...
                                                                        <div class="row ">
                                                                            ...
                                                                            <div class="col-sm-4">
                                                                                <i style="display:inline-block"
                                                                                   class="workadvisor workadvisor-target"></i>
                                                                                <h5 class="add_phone"
                                                                        ...
                                                                        <div class="row additional_phone"
                                                                             style="display:none">
                                                                            <div class="col-sm-4">
                                                                                <span>Telefone:</span>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-8">
                                                                                ...
                                                                                <textarea name="reachability"
                                                                                          class="form-control"><?php echo $val['reachability'] ?></textarea>
                                                                ...
                                                                <div class="row" style="margin-bottom: 25px">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <input class="js-switch add_install_address"
                                                                               style="display:inline-block"
                                                                               name="different" type="checkbox">
                                                                        <h5 style="display:inline-block">Abweichende
                                                                            Installationsadresse</h5>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-12">
                                                                        ...
                                                                        <div class="questions questions_modal row clearfix">
                                                                            <div class="col-xs-12 col-sm-6">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-xs-10 col-sm-10 col-md-11 float-right">
                                                                                        <input id="demo-text-input"
                                                                                               class="form-control"
                                                                                               name="question_<?php echo $k ?>"
                                                                                               placeholder="Question"
                                                                                               value="<?php echo $v['original']['text']; ?>"
                                                                                               type="text">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-xs-12 col-sm-4 anwort-input"
                                                                                 style="padding: 0">
                                                                                <input id="demo-text-input"
                                                                                       class="form-control"
                                                                                       name="answer_<?php echo $k ?>"
                                                                                       placeholder="Answer"
                                                                                       value="<?php echo $v['original']['answer']; ?>"
                                                                                       type="text">
                                                                            </div>
                                                                            <div class="col-xs-4 col-sm-2 text-left">
                                                                                <input class="js-switch"
                                                                                       style="display:inline-block;margin-left:100px"
                                                                                       name="public_question_<?php echo $k ?>"
                                                                                       type="checkbox">
                                                                            </div>
                                                                    ...
                                                                    <div class="notes_quations_modal row">
                                                                        <div class="questions questions_modal clearfix">
                                                                            ...
                                                                            <div class="col-xs-11 col-sm-4 question_2"
                                                                                 style="padding: 0">
                                                                                <input class="form-control"
                                                                                       name="question_2" placeholder=""
                                                                                       value="" type="text">
                                                                            </div>
                                                                            <div class="col-xs-4 col-xs-offset-1 col-sm-2 text-left">
                                                                                <input class="js-switch"
                                                                                       style="display: none; margin-left: 100px;"
                                                                                       name="public_question_23"
                                                                                       type="checkbox"
                                                                                       data-switchery="true">
                                                                        ...
                                                                        <div class="questions questions_modal clearfix">
                                                                            <div class="col-xs-12 col-sm-10">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-xs-11 col-sm-11 summernote_custom"
                                                                                         style="margin-bottom: 10px">
                                                                                                                        ...
                                                                                                                        <div class="row-fluid">
                                                                                                                            <div class="form-group">
                                                                                                                                <label>Text
                                                                                                                                    to
                                                                                                                                    display</label>
                                                                                                                                <input class="note-link-text form-control span12"
                                                                                                                                       type="text">
                                                                                                                            </div>
                                                                                                                            <div class="form-group">
                                                                                                                                <label>To
                                                                                                                                    ...
                                                                                                                                    link
                                                                                                                                    go?</label>
                                                                                                                                <input class="note-link-url form-control span12"
                                                                                                                                       type="text">
                                                                                                                            </div>
                                                                                                                            <div class="checkbox">
                                                                                                                                <label>
                                                                                                                            ...
                                                                                                                            <p class="text-center">
                                                                                                                                <a href="//hackerwins.github.io/summernote/"
                                                                                                                                   target="_blank">Summernote
                                                                                                                                    0.5.8</a>
                                                                                                                                ·
                                                                                                                                <a href="//github.com/HackerWins/summernote"
                                                                                                ...
                                                                                                <div class="note-toolbar btn-toolbar">
                                                                                                    <div class="note-font btn-group">
                                                                                                        ...
                                                                                                        <button type="button"
                                                                                                                class="btn btn-default btn-sm btn-small"
                                                                                                                title=""
                                                                                                                data-event="superscript"
                                                                                                                tabindex="-1"
                                                                                                                data-original-title="Superscript">
                                                                                                            <i class="fa fa-superscript icon-superscript"></i>
                                                                                                        </button>
                                                                                                        <button type="button"
                                                                                                                class="btn btn-default btn-sm btn-small"
                                                                                                                title=""
                                                                                                                data-event="subscript"
                                                                                                                tabindex="-1"
                                                                                                                data-original-title="Subscript">
                                                                                                        ...
                                                                                                        <button type="button"
                                                                                                                ...
                                                                                                                aria-describedby="tooltip279324">
