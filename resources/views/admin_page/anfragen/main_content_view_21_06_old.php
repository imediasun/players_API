                                        ...
                                        <div class="col-md-8 right-checkbox">
                                            <div class="flex-start fais" style="flex-wrap: wrap">
                                                ...
                                                <label class="custom-checkbox" style="margin-right: 15px; margin-bottom: 10px;">
                                                    <input type="checkbox" value="heating_oil" class="service" checked>
                                                    <span></span>
                                                    Heizung Öil
                                                </label>
                                                <label class="custom-checkbox" style="margin-right: 15px; margin-bottom: 10px;">
                                                    <input type="checkbox" value="heating_gas" class="service" checked>
                                                    <span></span>
                                                    Heizung Gas
                                                </label>
                                                <label class="custom-checkbox" style="margin-right: 15px; margin-bottom: 10px;">
                                                    <input type="checkbox" value="solar" class="service" checked>
                                                    <span></span>
                                                    Solar
                                                </label>
                                                <label class="custom-checkbox" style="margin-right: 15px; margin-bottom: 10px;">
                                                    <input type="checkbox" value="bath" class="service" checked>
                                                    <span></span>
                                                    Bad
                                                </label>
                                            </div>
                                ...
                                */
                                ...
                                $partners=0;
                                    ...
                                    $questinarys= App\Questionary::where('id_client', $val['id'])
                                        ->get();
                                    ?>
                                    <div class="col-xs-12 <?=$val['service']?>" id="client<?php echo $val['id'] ?>">
                                                ...
                                                <div class="row mr-0">
                                                    <div class="panel-footer bgt bt-1 anfragen-card-foot">
                                                        ...
                                                        <ul class="pull-right butons_list">
                                                            ...
                                                            <li>
                                                                <input class="hidden_active" type="hidden" value="<?php echo $val['id'] ?>">
                                                               <button class="del_client_btn btn-md btn_links" onclick="Anfragen.delete_client(this)"><i class="workadvisor workadvisor-rubbish-bin"></i><span>Entfernen</span></button>
                                                            </li>
                                                        </ul>
