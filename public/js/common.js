...
jQuery(document).ready(function() {
 ...
 /* jQuery("#nav > li").click(function() {
  ...
  jQuery("#nav li.level0.nav-5").click(function() {
    var el = jQuery(this).find(".level0-wrapper");
    el.hide();
    el.css("left", "0");
    el.stop(true, true).delay(150).fadeIn(300, "easeOutCubic");
    ...
    if(!window.navi) {
      var ul_height = jQuery(this).find('.level0-wrapper').height();
      jQuery(this).parent().parent().next('.nav-inner').animate({
        top: ul_height + 50,
      })
      var nav_val = jQuery("nav").height()
      jQuery("nav").height(nav_val + ul_height + 100)
      window.navi = 1;
    }
  }).mouseleave(function() {
  ...
  var scrolled = false;
  jQuery("#nav li.level0.drop-menu").click(function() {
    if (jQuery(window).width() >= 740) {
      jQuery(this).children('ul.level1').fadeIn(100);
    }

    if(!window.navi){
    var ul_height = jQuery(this).children('ul.level1').height();
    jQuery(this).parent().parent().next('.nav-inner').animate({
      top : ul_height+50,
    })
